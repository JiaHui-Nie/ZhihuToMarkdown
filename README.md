# ZhihuToMarkdown
---
一个可以将知乎专栏保存为markdown文件的油猴脚本。
<center>
    <img alt="Support" src="https://img.shields.io/badge/支持-TramperMonkey-blue" />
    <img alt="UnSupport" src="https://img.shields.io/badge/暂不支持-Gif-red" />
</center>
...
受限于时间仓促和本人水平，代码可以使用，但不保证效果最佳，以实际体验效果为准。
...
支持正版：如果您发现某个程序或资源对您有帮助或您喜欢它，请积极支持正版。购买和注册正版软件不仅可以获取官方的支持和更新，而且可以享受更多的功能和服务。
...
[![Star History Chart](https://api.star-history.com/svg?repos=JiaHui-Nie/ZhihuToMarkdown&type=Date)](https://star-history.com/#JiaHui-Nie/ZhihuToMarkdown&Date)